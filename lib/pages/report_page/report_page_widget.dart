...
import '/pages/report_common_component/report_common_component_widget.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        if (FFAppState().reportList.isNotEmpty)
          Expanded(
            child: Padding(
              ...
              child: ListView(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Builder(
                      builder: (context) {
                        final reportList = FFAppState().reportList.toList();
                        return GridView.builder(
                          ...
                          itemBuilder: (context, reportListIndex) {
                            final reportListItem = reportList[reportListIndex];
                            return ReportCommonComponentWidget(
                              key: Key(
                                  'Keymlm_${reportListIndex}_of_${reportList.length}'),
                              image: reportListItem.image,
                              title: reportListItem.title,
                              subTitle: reportListItem.subTitle,
                            );
                          },
                        );
                      },
