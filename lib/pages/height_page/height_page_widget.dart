...
class HeightPageWidget extends StatefulWidget {
  const HeightPageWidget({super.key});

  @override
  State<HeightPageWidget> createState() => _HeightPageWidgetState();
}
                      ...
                      Align(
                        ...
                        child: Padding(
                          ...
                          child: Builder(
                            builder: (context) {
                              final heightList =
                                  functions.heightList()?.toList() ?? [];
                              return SizedBox(
                                width: double.infinity,
                                height: 600.0,
                                child: CarouselSlider.builder(
                                  itemCount: heightList.length,
                                  itemBuilder: (context, heightListIndex, _) {
                                    final heightListItem =
                                        heightList[heightListIndex];
                                    return Column(
                                      mainAxisSize: MainAxisSize.max,
                                      mainAxisAlignment:
                                  ...
                                  options: CarouselOptions(
                                    initialPage: min(25, heightList.length - 1),
